...
scatter(metadata.TEMP,temp_freference,40,metadata.Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k')
...
scatter(metadata.SALT,salt_freference,40,metadata.Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k')
...
scatter(metadata.CHLA,chl_freference,40,metadata.Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k');
title('\rm(c) CHLA (mg/m^3)')
axis('square');axis([mnlim mxlim mnlim mxlim]);caxis([100 250])
...
scatter(metadata.DO,DO_freference,40,metadata.Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k');
...
scatter(metadata.PO4F,po4_freference,40,metadata.Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k');
title('\rm(f) PO4 (\mu M)')
axis('square');axis([mnlim mxlim mnlim mxlim]);caxis([100 250])
...
scatter(metadata.NH4F,nh4_freference,40,metadata.Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k');
...
scatter((metadata.NO3F),(no3_freference),40,metadata.Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k');
...
scatter(metadata.NO23F,no2_freference+no3_freference,40,metadata.Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k');
