...
figure(2);clf
subplot(331)
mnlim=floor(min([TEMP' temp_freference']));
mxlim=ceil(max([TEMP' temp_freference']));
scatter(TEMP,temp_freference,40,Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k')
title('(a) Temperature (^\circ C)')
axis('square');axis([mnlim mxlim mnlim mxlim]);caxis([100 250])
COD=1-mean((TEMP-temp_freference).^2)/std(TEMP.^2);
text((mnlim+mxlim)*0.4,mnlim+(mxlim-mnlim)/10,['COD=' num2str(COD,'%5.3f')])
ylabel('Model Predictions')

subplot(332)
mnlim=floor(min([SALT' salt_freference']*10))/10;
mxlim=ceil(max([SALT' salt_freference']*10))/10;
scatter(SALT,salt_freference,40,Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k')
title('(b) Salinity (PSU)')
axis('square');axis([mnlim mxlim mnlim mxlim]);caxis([100 250])
COD=1-mean((SALT-salt_freference).^2)/std(SALT.^2);
text((mnlim+mxlim)*0.4,mnlim+(mxlim-mnlim)/10,['COD=' num2str(COD,'%5.3f')])

subplot(334)
mnlim=floor(min([DO' DO_freference']));
mxlim=ceil(max([DO' DO_freference']));
scatter(DO,DO_freference,40,Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k');
title('(d) Oxygen (\muM)')
ylabel('Model Predictions')
axis('square');axis([mnlim mxlim mnlim mxlim]);caxis([100 250])
COD=1-mean((DO-DO_freference).^2)/std(DO.^2);
text((mnlim+mxlim)*0.4,mnlim+(mxlim-mnlim)/10,['COD=' num2str(COD,'%5.3f')])

subplot(338)
mnlim=floor(min(([NO3F' no3_freference'])));
mxlim=ceil(max(([NO3F' no3_freference'])));
scatter((NO3F),(no3_freference),40,Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k');
title('(h) Nitrate (\mu M)')
axis('square');axis([mnlim mxlim mnlim mxlim]);caxis([100 250])
COD=1-mean(((NO3F)-(no3_freference)).^2)/std((NO3F).^2);
text((mnlim+mxlim)*0.4,mnlim+(mxlim-mnlim)/10,['COD=' num2str(COD,'%5.3f')])
xlabel('Observations')
hc=colorbar('Location',['south'])

subplot(339)
mnlim=floor(min([NO23F' no2_freference'+no3_freference']));
mxlim=ceil(max([NO23F' no2_freference'+no3_freference']));
scatter(NO23F,no2_freference+no3_freference,40,Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k');
title('(i) Nitrate+Nitrite (\mu M)')
xlabel('Observations')
axis('square');axis([mnlim mxlim mnlim mxlim]);caxis([100 250])
COD=1-mean((NO23F-no2_freference-no3_freference).^2)/std(NO23F.^2);
text((mnlim+mxlim)*0.4,mnlim+(mxlim-mnlim)/10,['COD=' num2str(COD,'%5.3f')])
%colorbar('Location','north')

subplot(337)
mnlim=floor(min([NH4F' nh4_freference']));
mxlim=ceil(max([NH4F' nh4_freference']));
scatter(NH4F,nh4_freference,40,Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k');
title('(g) Ammonium (\mu M)')
ylabel('Model Predictions')
xlabel('Observations')
axis('square');axis([mnlim mxlim mnlim mxlim]);caxis([100 250])
COD=1-mean((NH4F-nh4_freference).^2)/std(NH4F.^2);
text((mnlim+mxlim)*0.4,mnlim+(mxlim-mnlim)/10,['COD=' num2str(COD,'%5.3f')])


subplot(336)
mnlim=floor(min([PO4F' po4_freference']));
mxlim=ceil(max([PO4F' po4_freference']));
scatter(PO4F,po4_freference,40,Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k');
title('(f) PO4 (\mu M)')
axis('square');axis([mnlim mxlim mnlim mxlim]);caxis([100 250])
COD=1-mean((PO4F-po4_freference).^2)/std((PO4F).^2);
text(mnlim+(mxlim-mnlim)*0.4,mnlim+(mxlim-mnlim)/10,['COD=' num2str(COD,'%5.3f')])

subplot(335)
mnlim=floor(min([PH' pH_freference]));
mxlim=ceil(max([PH' pH_freference]));
scatter(PH,pH_freference,40,Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k');
title('(e) PH')
axis('square');axis([mnlim mxlim mnlim mxlim]);caxis([100 250])
COD=1-mean((PH-pH_freference').^2)/std(PH.^2);
text(mnlim+(mxlim-mnlim)*0.4,mnlim+(mxlim-mnlim)/10,['COD=' num2str(COD,'%5.3f')])


subplot(333)
mnlim=floor(min([CHLA' chl_freference']));
mxlim=ceil(max([CHLA' chl_freference']));
scatter(CHLA,chl_freference,40,Yearday,'filled');hold on;plot([mnlim mxlim],[mnlim mxlim],'k');
title('(c) CHLA (mg/m^3)')
axis('square');axis([mnlim mxlim mnlim mxlim]);caxis([100 250])
