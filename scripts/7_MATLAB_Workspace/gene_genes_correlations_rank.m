...
%upload
test_uat_X=readtable("gene_gene_correl.X.txt");
test_uat_Y=readtable("gene_gene_correl.Y.txt");
...
writematrix(pval, "pval_gene_gene_rank.txt");
writematrix(corr_obs, "corr_gene_gene_rank.txt");